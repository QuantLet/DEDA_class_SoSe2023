...
def preprocess_text(first_input_folder = None, theses = None, inter_output_folder = None, verbose = False):
    ...
    if verbose:
        ...
        plt.savefig('1_lengths_dist_w_shortwords.png', transparent=True, dpi = 300)
        plt.show()
        plt.close()
        ...
        plt.xlabel('Length')
        plt.ylabel('Amount of Words')
        plt.savefig('2_lengths_dist_wo_shortwords.png', transparent=True, dpi = 300)
        plt.show()
        plt.close()
        ...
        plt.savefig('3_word_dist_w_stopwords.png', transparent=True, dpi = 300)
        # Show plot
        plt.show()
        # Close plot
        plt.close()
        ...
        plt.savefig('4_word_dist_wo_stopwords.png', transparent = True, dpi = 300)
        # Show plot
        plt.show()
        # Close plot
        plt.close()
        ...
        plt.ylabel('Words')
        plt.savefig('5_words_frequency_distribution.png', transparent = True, dpi = 300)
        plt.show()
        plt.close()
        print('\n')
        ...
        plt.xlabel('Frequency')
        plt.ylabel('Words')
        plt.savefig('6_words_frequency_distribution_smallest.png', transparent = True, dpi = 300)
        plt.show()
        plt.close()
        print('\n')
